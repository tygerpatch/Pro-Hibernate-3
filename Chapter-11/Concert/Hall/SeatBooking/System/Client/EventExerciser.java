package Concert.Hall.SeatBooking.System.Client;
...
import Concert.Hall.SeatBooking.System.POJOs.TestEntity;
...
public class EventExerciser {
  ...
  private static class NoisyAutoFlushEventListener extends DefaultAutoFlushEventListener {
  ...
  private static class NoisyDeleteEventListener extends DefaultDeleteEventListener {
  ...
  private static class NoisyDirtyCheckEventListener extends DefaultDirtyCheckEventListener {
  ...
  private static class NoisyEvictEventListener extends DefaultEvictEventListener {
  ...
  private static class NoisyFlushEntityEventListener extends DefaultFlushEntityEventListener {
  ...
  private static class NoisyFlushEventListener extends DefaultFlushEventListener {
  ...
  private static class NoisyInitializeCollectionEventListener extends DefaultInitializeCollectionEventListener {
  ...
  private static class NoisyLoadEventListener extends DefaultLoadEventListener {
    public Object onLoad(LoadEvent event, LoadType type) throws HibernateException {
      System.out.println("LoadEventListener.onLoad(LoadEvent,LoadType)");
      return super.onLoad(event, type);
    }
  }

  private static class NoisyLockEventListener extends DefaultLockEventListener {
  ...
  private static class NoisyMergeEventListener extends DefaultMergeEventListener {
  ...
  private static class NoisyPersistEventListener extends DefaultPersistEventListener {
  ...
  private static class NoisyPostInsertEventListener extends DefaultPostInsertEventListener {
  ...
  private static class NoisyPostLoadEventListener extends DefaultPostLoadEventListener {
  ...
  private static class NoisyPreDeleteEventListener extends DefaultPreDeleteEventListener {
  ...
  private static class NoisyPreInsertEventListener extends DefaultPreInsertEventListener {
  ...
  private static class NoisyPreLoadEventListener extends DefaultPreLoadEventListener {
  ...
  private static class NoisyPreUpdateEventListener extends DefaultPreUpdateEventListener {
  ...
  private static class NoisyRefreshEventListener extends DefaultRefreshEventListener {
  ...
  private static class NoisyReplicateEventListener extends DefaultReplicateEventListener {
  ...
  private static class NoisySaveOrUpdateEventListener extends DefaultSaveOrUpdateEventListener {
